...
async function onSubmit(values: z.infer<typeof formSchema>) {
  try {
    ...
    // Ensure the username (email) is not empty or invalid
    if (!username.trim()) {
      toast({
    ...
    <div className="w-screen h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="flex justify-start items-center flex-col">
          ...
          >
            ...
            <small className="mb-6">
              Start receiving and sending payments through FairShare.
            </small>
        ...
        <div className="bg-black text-white dark:bg-slate-200 lg:flex justify-center items-center rounded-l-3xl h-screen hidden dark:text-background flex-col">
          ...
          />
          <p className="text-5xl font-black ">FairShare</p>
